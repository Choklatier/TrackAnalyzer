...
The code is written to be used in [a old VMs to access CMS Open data from Run1](https://opendata.cern.ch/record/250). Dataset such, as the [2010B MinimumBias](https://opendata.cern.ch/record/42), can be ran on using this setup.
